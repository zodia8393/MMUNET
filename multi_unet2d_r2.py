...
class Multi_Unet_r2(nn.Module):

    def __init__(self, input_nc, output_nc, ngf=32):
        super(Multi_Unet_r2, self).__init__()
        ...
        self.upLayer1 = UpBlock2d_r2(self.out_dim * 16, self.out_dim * 8)
        self.upLayer2 = UpBlock2d_r2(self.out_dim * 8, self.out_dim * 4)
        self.upLayer3 = UpBlock2d_r2(self.out_dim * 4, self.out_dim * 2)
        self.upLayer4 = UpBlock2d_r2(self.out_dim * 2, self.out_dim * 1)
