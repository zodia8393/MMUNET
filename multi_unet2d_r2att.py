...
class Multi_Unet_r2att(nn.Module):

    def __init__(self, input_nc, output_nc, ngf=32):
        super(Multi_Unet_r2att, self).__init__()
        ...
        self.down_1_0 = RRCNN_block(self.in_dim, self.out_dim)
        self.pool_1_0 = maxpool()
        self.down_2_0 = RRCNN_block(self.out_dim * 4, self.out_dim * 2)
        self.pool_2_0 = maxpool()
        self.down_3_0 = RRCNN_block(self.out_dim * 12, self.out_dim * 4)
        self.pool_3_0 = maxpool()
        self.down_4_0 = RRCNN_block(self.out_dim * 28, self.out_dim * 8)
        self.pool_4_0 = maxpool()

        # Encoder (Modality 2) T1
        self.down_1_1 = RRCNN_block(self.in_dim, self.out_dim)
        self.pool_1_1 = maxpool()
        self.down_2_1 = RRCNN_block(self.out_dim * 4, self.out_dim * 2)
        self.pool_2_1 = maxpool()
        self.down_3_1 = RRCNN_block(self.out_dim * 12, self.out_dim * 4)
        self.pool_3_1 = maxpool()
        self.down_4_1 = RRCNN_block(self.out_dim * 28, self.out_dim * 8)
        self.pool_4_1 = maxpool()

        # Encoder (Modality 3) T1c
        self.down_1_2 = RRCNN_block(self.in_dim, self.out_dim)
        self.pool_1_2 = maxpool()
        self.down_2_2 = RRCNN_block(self.out_dim * 4, self.out_dim * 2)
        self.pool_2_2 = maxpool()
        self.down_3_2 = RRCNN_block(self.out_dim * 12, self.out_dim * 4)
        self.pool_3_2 = maxpool()
        self.down_4_2 = RRCNN_block(self.out_dim * 28, self.out_dim * 8)
        self.pool_4_2 = maxpool()

        # Encoder (Modality 4) T2
        self.down_1_3 = RRCNN_block(self.in_dim, self.out_dim)
        self.pool_1_3 = maxpool()
        self.down_2_3 = RRCNN_block(self.out_dim * 4, self.out_dim * 2)
        self.pool_2_3 = maxpool()
        self.down_3_3 = RRCNN_block(self.out_dim * 12, self.out_dim * 4)
        self.pool_3_3 = maxpool()
        self.down_4_3 = RRCNN_block(self.out_dim * 28, self.out_dim * 8)
        self.pool_4_3 = maxpool()

        # Bridge between Encoder-Decoder
        self.bridge = RRCNN_block(self.out_dim * 60, self.out_dim * 16)

        # ~~~ Decoding Path ~~~~~~ #

        self.upLayer1 = UpBlock2d_r2att(self.out_dim * 16, self.out_dim * 8)
        self.upLayer2 = UpBlock2d_r2att(self.out_dim * 8, self.out_dim * 4)
        self.upLayer3 = UpBlock2d_r2att(self.out_dim * 4, self.out_dim * 2)
        self.upLayer4 = UpBlock2d_r2att(self.out_dim * 2, self.out_dim * 1)
